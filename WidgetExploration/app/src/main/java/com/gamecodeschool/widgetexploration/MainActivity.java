    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cbTransparency.setOnCheckedChangeListener(
                new CompoundButton.OnCheckedChangeListener(){
                    ...
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                        if(cbTransparency.isChecked()) imageView.setAlpha(.1f);
        ...
        cbTint.setOnCheckedChangeListener(
                new CompoundButton.OnCheckedChangeListener(){
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked){
                        if(cbTint.isChecked()) imageView.setColorFilter(Color.argb(150,0,0,0));
                        else imageView.setColorFilter(Color.argb(0,0,0,0));
                    }
                }
        );
        ...
        radioGroup.setOnCheckedChangeListener(new
                RadioGroup.OnCheckedChangeListener(){
                    ...
                    public void onCheckedChanged(RadioGroup group, int checkedId){
                        ...
                        switch(rb.getId()){
                            case R.id.radioButtonEthiopia:
                                tClock.setTimeZone("Africa/Addis_Ababa");
                                break;
        ...
        switch1.setOnCheckedChangeListener( new
                CompoundButton.OnCheckedChangeListener(){
                    @Override
                    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked){
                        if(isChecked) textView.setVisibility(View.VISIBLE);
